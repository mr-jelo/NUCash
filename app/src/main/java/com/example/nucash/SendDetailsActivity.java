...
public class SendDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendButton.setOnClickListener(v -> {
            ...
            Toast.makeText(SendDetailsActivity.this, "Transaction Complete", Toast.LENGTH_SHORT).show();

            // Redirect to HomeFragment
            Intent intentToHome = new Intent(SendDetailsActivity.this, MainActivity.class);
